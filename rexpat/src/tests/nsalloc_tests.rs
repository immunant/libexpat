...
unsafe extern "C" fn nsalloc_setup() {
    ...
    crate::src::tests::common::g_parser = crate::src::lib::xmlparse::XML_ParserCreate_MM(
        ...
        &raw mut ns_sep as *mut crate::expat_external_h::XML_Char,
    );
...
unsafe extern "C" fn test_nsalloc_xmlns() {
    ...
    while i < max_alloc_count {
        ...
        crate::src::lib::xmlparse::XML_SetDefaultHandler(
            ...
            Some(
                crate::src::tests::dummy::dummy_default_handler
                    as unsafe extern "C" fn(
                        *mut ::core::ffi::c_void,
...
unsafe extern "C" fn test_nsalloc_parse_buffer() {
    ...
    if crate::src::lib::xmlparse::XML_GetErrorCode(crate::src::tests::common::g_parser)
        as ::core::ffi::c_uint
        != crate::expat_h::XML_ERROR_NO_BUFFER as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        crate::src::tests::minicheck::_fail(
            b"/mnt/ssd1/ahomescu/development/immunant/libexpat/expat/tests/nsalloc_tests.c\0"
                .as_ptr() as *const ::core::ffi::c_char,
    ...
    crate::src::tests::common::g_allocation_count = 0 as ::core::ffi::c_int;
    if crate::src::lib::xmlparse::XML_ParseBuffer(
        crate::src::tests::common::g_parser,
        0 as ::core::ffi::c_int,
        crate::expat_h::XML_FALSE as ::core::ffi::c_int,
    ...
    if crate::src::lib::xmlparse::XML_GetErrorCode(crate::src::tests::common::g_parser)
        as ::core::ffi::c_uint
        != crate::expat_h::XML_ERROR_NO_MEMORY as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        crate::src::tests::minicheck::_fail(
            b"/mnt/ssd1/ahomescu/development/immunant/libexpat/expat/tests/nsalloc_tests.c\0"
                .as_ptr() as *const ::core::ffi::c_char,
    ...
    if crate::src::lib::xmlparse::XML_ResumeParser(crate::src::tests::common::g_parser)
        as ::core::ffi::c_uint
        != crate::expat_h::XML_STATUS_ERROR as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        crate::src::tests::minicheck::_fail(
    ...
    if crate::src::lib::xmlparse::XML_GetErrorCode(crate::src::tests::common::g_parser)
        as ::core::ffi::c_uint
        != crate::expat_h::XML_ERROR_NOT_SUSPENDED as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        crate::src::tests::common::_xml_failure(
            crate::src::tests::common::g_parser,
            b"/mnt/ssd1/ahomescu/development/immunant/libexpat/expat/tests/nsalloc_tests.c\0"
    ...
    crate::src::lib::xmlparse::XML_SetCharacterDataHandler(
        crate::src::tests::common::g_parser,
        Some(
            crate::src::tests::handlers::clearing_aborting_character_handler
                as unsafe extern "C" fn(
                    *mut ::core::ffi::c_void,
                    *const crate::expat_external_h::XML_Char,
                    ::core::ffi::c_int,
    ...
    if !buffer.is_null() {
        ...
        crate::stdlib::__assert_fail(
            ...
            crate::stdlib::__ASSERT_FUNCTION_3.as_ptr(),
        );
    };
    crate::stdlib::memcpy(
        buffer,
    ...
    if !crate::src::lib::xmlparse::XML_GetBuffer(
        crate::src::tests::common::g_parser,
        crate::stdlib::strlen(text) as ::core::ffi::c_int,
    )
    .is_null()
...
unsafe extern "C" fn test_nsalloc_realloc_binding_uri() {
    ...
    if crate::src::tests::common::_XML_Parse_SINGLE_BYTES(
        crate::src::tests::common::g_parser,
        first,
        crate::stdlib::strlen(first) as ::core::ffi::c_int,
        crate::expat_h::XML_TRUE as ::core::ffi::c_int,
    ) as ::core::ffi::c_uint
        == crate::expat_h::XML_STATUS_ERROR as ::core::ffi::c_int as ::core::ffi::c_uint
    {
    ...
    while i < max_realloc_count {
        ...
        crate::src::tests::common::g_reallocation_count = i as ::core::ffi::c_int;
        if crate::src::tests::common::_XML_Parse_SINGLE_BYTES(
            crate::src::tests::common::g_parser,
            second,
            crate::stdlib::strlen(second) as ::core::ffi::c_int,
            crate::expat_h::XML_TRUE as ::core::ffi::c_int,
        ) as ::core::ffi::c_uint
            != crate::expat_h::XML_STATUS_ERROR as ::core::ffi::c_int as ::core::ffi::c_uint
        {
...
unsafe extern "C" fn test_nsalloc_realloc_long_context_in_dtd() {
    ...
    let mut text2: *const ::core::ffi::c_char = b"<:doc>\0"
        .as_ptr() as *const ::core::ffi::c_char;
    let mut options: [crate::src::tests::handlers::ExtOption; 2] = [
        crate::src::tests::handlers::ExtOption {
            system_id: b"foo/First\0".as_ptr() as *const crate::expat_external_h::XML_Char,
...
pub unsafe extern "C" fn make_nsalloc_test_case(mut s: *mut crate::src::tests::minicheck::Suite) {
    let mut tc_nsalloc: *mut crate::src::tests::minicheck::TCase =
    ...
    crate::src::tests::minicheck::suite_add_tcase(
        ...
        tc_nsalloc as *mut crate::src::tests::minicheck::TCase,
    );
