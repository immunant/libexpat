...
pub mod internal_h {
    ...
    pub const EXPAT_MALLOC_PADDING: usize = crate::internal_h::EXPAT_MALLOC_ALIGNMENT
        .wrapping_sub(::core::mem::size_of::<crate::__stddef_size_t_h::size_t>());
}
pub mod siphash_h {
    pub const SIPHASH_INITIALIZER: crate::siphash_h::siphash = crate::siphash_h::siphash {
...
pub mod expat_h {
    use crate::src::xmlparse::XML_ParserStruct;
