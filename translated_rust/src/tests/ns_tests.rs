...
unsafe extern "C" fn namespace_setup() {
    unsafe {
        g_parser = XML_ParserCreateNS(::core::ptr::null::<XML_Char>(), ' ' as i32 as XML_Char);
        if g_parser.is_null() {
            _fail(
    ...
    unsafe {
            ...
            != XML_INITIALIZED as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            _fail(
                ...
                b"parsing status doesn't start INITIALIZED\0".as_ptr()
            ...
            != XML_INITIALIZED as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            _fail(
                ...
                b"parsing status doesn't reset to INITIALIZED\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    }
...
unsafe extern "C" fn test_ns_unbound_prefix_on_element() {
    unsafe {
        ...
        let mut text: *const ::core::ffi::c_char =
            b"<a:doc/>\0".as_ptr() as *const ::core::ffi::c_char;
        _expect_failure(
            text,
            XML_ERROR_UNBOUND_PREFIX,
...
unsafe extern "C" fn test_ns_double_colon() {
    unsafe {
        ...
        if status as ::core::ffi::c_uint
            ...
            || XML_GetErrorCode(g_parser) as ::core::ffi::c_uint
...
unsafe extern "C" fn test_ns_double_colon_element() {
    unsafe {
        ...
        let mut text: *const ::core::ffi::c_char =
            b"<foo:bar:e xmlns:foo='http://example.org/' />\0".as_ptr()
                as *const ::core::ffi::c_char;
        let status: XML_Status = _XML_Parse_SINGLE_BYTES(
            g_parser,
            text,
    ...
    unsafe {
                ...
                .wrapping_div(::core::mem::size_of::<test_case>() as usize)
        {
            ...
            let mut parser: XML_Parser =
                XML_ParserCreateNS(::core::ptr::null::<XML_Char>(), cases[i as usize].namesep);
            XML_SetElementHandler(
                parser,
                Some(
                    dummy_start_element
