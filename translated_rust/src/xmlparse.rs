...
unsafe extern "C" fn getContext(
    ...
    if !(*dtd).defaultPrefix.binding.is_null() {
            ...
            && poolGrow(&raw mut (*parser).m_tempPool) == 0
        {
            ...
            let c2rust_fresh47 = (*parser).m_tempPool.ptr;
            (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
            *c2rust_fresh47 = 0x3d as crate::expat_external_h::XML_Char;
            1 as ::core::ffi::c_int
        } == 0
        {
            return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
        ...
        while i < len {
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh48 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh48 = *(*(*dtd).defaultPrefix.binding).uri.offset(i as isize);
                1 as ::core::ffi::c_int
            } == 0
            {
                return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
    ...
    loop {
        ...
        if needSep as ::core::ffi::c_int != 0
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh49 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh49 = 0xc as crate::expat_external_h::XML_Char;
                1 as ::core::ffi::c_int
            }) == 0
        {
            return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
        ...
        while *s != 0 {
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh50 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh50 = *s;
                1 as ::core::ffi::c_int
            } == 0
            ...
            && poolGrow(&raw mut (*parser).m_tempPool) == 0
        {
            ...
            let c2rust_fresh51 = (*parser).m_tempPool.ptr;
            (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
            *c2rust_fresh51 = 0x3d as crate::expat_external_h::XML_Char;
            1 as ::core::ffi::c_int
        } == 0
        {
            return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
        ...
        while i_0 < len_0 {
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh52 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh52 = *(*(*prefix).binding).uri.offset(i_0 as isize);
                1 as ::core::ffi::c_int
            } == 0
            {
                return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
    ...
    loop {
        ...
        if needSep as ::core::ffi::c_int != 0
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh53 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh53 = 0xc as crate::expat_external_h::XML_Char;
                1 as ::core::ffi::c_int
            }) == 0
        {
            return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
        ...
        while *s_0 != 0 {
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                let c2rust_fresh54 = (*parser).m_tempPool.ptr;
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh54 = *s_0;
                1 as ::core::ffi::c_int
            } == 0
        ...
        && poolGrow(&raw mut (*parser).m_tempPool) == 0
    {
        ...
        let c2rust_fresh55 = (*parser).m_tempPool.ptr;
        (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
        *c2rust_fresh55 = '\0' as crate::expat_external_h::XML_Char;
        1 as ::core::ffi::c_int
    } == 0
    {
        return ::core::ptr::null::<crate::expat_external_h::XML_Char>();
...
unsafe extern "C" fn setContext(
    ...
    while *context as ::core::ffi::c_int != '\0' as ::core::ffi::c_int {
        if *s as ::core::ffi::c_int == 0xc as ::core::ffi::c_int
            || *s as ::core::ffi::c_int == '\0' as ::core::ffi::c_int
        {
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh61 = '\0' as crate::expat_external_h::XML_Char;
                1 as ::core::ffi::c_int
            } == 0
            {
                return crate::expat_h::XML_FALSE;
                ...
                == 0 as isize
            {
                    ...
                    && poolGrow(&raw mut (*parser).m_tempPool) == 0
                {
                    ...
                    (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                    *c2rust_fresh62 = '\0' as crate::expat_external_h::XML_Char;
                    1 as ::core::ffi::c_int
                } == 0
                {
                    return crate::expat_h::XML_FALSE;
            ...
            while *context as ::core::ffi::c_int != 0xc as ::core::ffi::c_int
                && *context as ::core::ffi::c_int != '\0' as ::core::ffi::c_int
            {
                if if (*parser).m_tempPool.ptr
                    == (*parser).m_tempPool.end as *mut crate::expat_external_h::XML_Char
                    && poolGrow(&raw mut (*parser).m_tempPool) == 0
                ...
                && poolGrow(&raw mut (*parser).m_tempPool) == 0
            {
                ...
                (*parser).m_tempPool.ptr = (*parser).m_tempPool.ptr.offset(1);
                *c2rust_fresh64 = '\0' as crate::expat_external_h::XML_Char;
                1 as ::core::ffi::c_int
            } == 0
            {
                return crate::expat_h::XML_FALSE;
            ...
            (*parser).m_tempPool.ptr = (*parser).m_tempPool.start;
            if *context as ::core::ffi::c_int != '\0' as ::core::ffi::c_int {
                context = context.offset(1);
            }
            s = context;
        } else {
...
unsafe extern "C" fn dtdCopy(
    ...
    loop {
            ...
            && poolGrow(&raw mut (*newDtd).pool) == 0
        {
            ...
            let c2rust_fresh66 = (*newDtd).pool.ptr;
    ...
    loop {
        ...
        while i < (*newE).nDefaultAtts {
            (*(*newE).defaultAtts.offset(i as isize)).id = lookup(
                oldParser,
                &raw mut (*newDtd).attributeIds,
            ...
            if !(*(*oldE).defaultAtts.offset(i as isize)).value.is_null() {
                (*(*newE).defaultAtts.offset(i as isize)).value = poolCopyString(
                    &raw mut (*newDtd).pool,
...
unsafe extern "C" fn lookup(
    ...
    if (*table).size == 0 as crate::__stddef_size_t_h::size_t {
        ...
        if (*table).used >> (*table).power as ::core::ffi::c_int - 1 as ::core::ffi::c_int != 0 {
            ...
            let mut tsize_0: crate::__stddef_size_t_h::size_t =
                newSize.wrapping_mul(::core::mem::size_of::<*mut NAMED>());
            ...
            while i < (*table).size {
                if !(*(*table).v.offset(i as isize)).is_null() {
                    ...
                    *newV.offset(j as isize) = *(*table).v.offset(i as isize);
                }
                i = i.wrapping_add(1);
            }
            expat_free(
    ...
    *(*table).v.offset(i as isize) =
    ...
    (**(*table).v.offset(i as isize)).name = name;
