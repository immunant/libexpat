...
pub mod xmltok_impl_c {
    ...
    pub unsafe extern "C" fn normal_scanComment(
        ...
        if end.offset_from(ptr) >= (1 as ::core::ffi::c_int * 1 as ::core::ffi::c_int) as isize {
            if !(*ptr as ::core::ffi::c_int == 0x2d as ::core::ffi::c_int) {
                *nextTokPtr = ptr;
    ...
    pub unsafe extern "C" fn normal_scanLt(
        ...
        let action = normal_scan_lt_impl(normal, input, |kind, offset, width| {
            ...
            function.expect("non-null function pointer")(enc, ptr.add(offset)) != 0
        });
        match action {
    ...
    pub unsafe extern "C" fn normal_getAtts(
        ...
        loop {
                ...
                as ::core::ffi::c_int
            {
                ...
                21 => {
                    if state as ::core::ffi::c_uint
                        == crate::xmltok_impl_c::inName as ::core::ffi::c_int as ::core::ffi::c_uint
                    {
                        state = crate::xmltok_impl_c::other;
    ...
    pub unsafe extern "C" fn little2_scanComment(
        ...
        if end.offset_from(ptr) >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize {
            if !(*ptr.offset(1 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                && *ptr.offset(0 as isize) as ::core::ffi::c_int == 0x2d as ::core::ffi::c_int)
            {
                *nextTokPtr = ptr;
                return crate::src::xmltok::XML_TOK_INVALID_1;
            }
    ...
    pub unsafe extern "C" fn little2_cdataSectionTok(
        ...
        match if *ptr.offset(1 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            4 => {
                ...
                if *ptr.offset(1 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    && *ptr.offset(0 as isize) as ::core::ffi::c_int == 0x5d as ::core::ffi::c_int
                {
                    ptr = ptr.offset(2 as ::core::ffi::c_int as isize);
                    if !(end.offset_from(ptr)
                        >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize)
            ...
            9 => {
                ...
                if (if *ptr.offset(1 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                    (*(enc as *const normal_encoding)).type_0[*ptr as ::core::ffi::c_uchar as usize]
                        as ::core::ffi::c_int
                } else {
                    unicode_byte_type(*ptr.offset(1 as isize), *ptr.offset(0 as isize))
        ...
        while end.offset_from(ptr) >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize {
            match if *ptr.offset(1 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                ...
                5 => {
                    if end.offset_from(ptr) < 2 as isize || false {
                        *nextTokPtr = ptr;
                        return crate::src::xmltok::XML_TOK_DATA_CHARS_1;
                    }
                    ptr = ptr.offset(2 as ::core::ffi::c_int as isize);
                ...
                6 => {
                    if end.offset_from(ptr) < 3 as isize || false {
                        *nextTokPtr = ptr;
                        return crate::src::xmltok::XML_TOK_DATA_CHARS_1;
                    }
                    ptr = ptr.offset(3 as ::core::ffi::c_int as isize);
                ...
                7 => {
                    if end.offset_from(ptr) < 4 as isize || false {
                        *nextTokPtr = ptr;
                        return crate::src::xmltok::XML_TOK_DATA_CHARS_1;
                    }
                    ptr = ptr.offset(4 as ::core::ffi::c_int as isize);
                ...
                '_gt: {
                    '_sol: {
                            ...
                            == 0 as ::core::ffi::c_int
                        {
                            ...
                            23 => {
                                ...
                                's_464: {
                                        ...
                                        == 0 as ::core::ffi::c_int
                                    {
                                        ...
                                        29 => {
                                            if namingBitmap[(((nmstrtPages[*ptr.offset(1 as isize)
                                                as ::core::ffi::c_uchar
                                                as usize]
                                                as ::core::ffi::c_int)
                                                << 3 as ::core::ffi::c_int)
                            ...
                            21 | 9 | 10 => {
                                ptr = ptr.offset(2 as ::core::ffi::c_int as isize);
                                's_616: while end.offset_from(ptr)
                                    >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize
                                {
                                    's_611: {
                                        match if *ptr.offset(1 as isize) as ::core::ffi::c_int
    ...
    pub unsafe extern "C" fn big2_scanComment(
        ...
        if end.offset_from(ptr) >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize {
            if !(*ptr.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                && *ptr.offset(1 as isize) as ::core::ffi::c_int == 0x2d as ::core::ffi::c_int)
            {
                *nextTokPtr = ptr;
                return crate::src::xmltok::XML_TOK_INVALID_1;
            }
    ...
    pub unsafe extern "C" fn big2_cdataSectionTok(
        ...
        match if *ptr.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            ...
            4 => {
                ...
                if *ptr.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int
                    && *ptr.offset(1 as isize) as ::core::ffi::c_int == 0x5d as ::core::ffi::c_int
                {
                    ptr = ptr.offset(2 as ::core::ffi::c_int as isize);
                    if !(end.offset_from(ptr)
                        >= (1 as ::core::ffi::c_int * 2 as ::core::ffi::c_int) as isize)
            ...
            9 => {
                ...
                if (if *ptr.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                    (*(enc as *const normal_encoding)).type_0[*ptr
                        .offset(1 as ::core::ffi::c_int as isize)
                        as ::core::ffi::c_uchar
                        as usize] as ::core::ffi::c_int
            ...
            match if *ptr.offset(0 as isize) as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                ...
                29 => {
                    if namingBitmap[(((nmstrtPages
                        ...
                        as ::core::ffi::c_int)
                        << 3 as ::core::ffi::c_int)
                        + (*ptr.offset(1 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int
                            >> 5 as ::core::ffi::c_int))
                        as usize]
                        & (1 as ::core::ffi::c_uint)
...
unsafe extern "C" fn utf8_isName2(
    ...
    return (namingBitmap[(((namePages[(*(p as *const ::core::ffi::c_uchar).offset(0 as isize)
        ...
        << 3 as ::core::ffi::c_int)
        + ((*(p as *const ::core::ffi::c_uchar).offset(0 as isize) as ::core::ffi::c_int
            & 3 as ::core::ffi::c_int)
            << 1 as ::core::ffi::c_int)
...
unsafe extern "C" fn utf8_isNmstrt2(
    ...
    return (namingBitmap[(((nmstrtPages[(*(p as *const ::core::ffi::c_uchar).offset(0 as isize)
        as ::core::ffi::c_int
        >> 2 as ::core::ffi::c_int
        & 7 as ::core::ffi::c_int) as usize] as ::core::ffi::c_int)
        << 3 as ::core::ffi::c_int)
...
unsafe extern "C" fn utf8_isInvalid4(
    ...
    return (*(p as *const ::core::ffi::c_uchar).offset(3 as isize) as ::core::ffi::c_int
        & 0x80 as ::core::ffi::c_int
        == 0 as ::core::ffi::c_int
        || *(p as *const ::core::ffi::c_uchar).offset(3 as isize) as ::core::ffi::c_int
            & 0xc0 as ::core::ffi::c_int
            == 0xc0 as ::core::ffi::c_int
        || *(p as *const ::core::ffi::c_uchar).offset(2 as isize) as ::core::ffi::c_int
            & 0x80 as ::core::ffi::c_int
...
unsafe extern "C" fn utf8_toUtf16(
    ...
    '_after: {
        while from < fromLim && to < toLim as *mut ::core::ffi::c_ushort {
            ...
            {
                5 => {
                    if fromLim.offset_from(from) < 2 as isize {
                        res = crate::src::xmltok::XML_CONVERT_INPUT_INCOMPLETE;
                        break '_after;
                    } else {
                        let c2rust_fresh0 = to;
                        to = to.offset(1);
                        *c2rust_fresh0 = ((*from.offset(0 as isize) as ::core::ffi::c_int
                            & 0x1f as ::core::ffi::c_int)
                            << 6 as ::core::ffi::c_int
                            | *from.offset(1 as isize) as ::core::ffi::c_int
                ...
                6 => {
                    if fromLim.offset_from(from) < 3 as isize {
                        res = crate::src::xmltok::XML_CONVERT_INPUT_INCOMPLETE;
                        break '_after;
                    } else {
                        let c2rust_fresh1 = to;
                        to = to.offset(1);
                        *c2rust_fresh1 = ((*from.offset(0 as isize) as ::core::ffi::c_int
                            & 0xf as ::core::ffi::c_int)
                            << 12 as ::core::ffi::c_int
                            | (*from.offset(1 as isize) as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_int)
                                << 6 as ::core::ffi::c_int
                            | *from.offset(2 as isize) as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_int)
                            as ::core::ffi::c_ushort;
                ...
                7 => {
                    ...
                    if toLim.offset_from(to) < 2 as isize {
                        res = crate::src::xmltok::XML_CONVERT_OUTPUT_EXHAUSTED;
                        break '_after;
                    } else if fromLim.offset_from(from) < 4 as isize {
                        res = crate::src::xmltok::XML_CONVERT_INPUT_INCOMPLETE;
                        break '_after;
                    } else {
                        n = ((*from.offset(0 as isize) as ::core::ffi::c_int
                            ...
                            | (*from.offset(2 as isize) as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_int)
                                << 6 as ::core::ffi::c_int
                            | *from.offset(3 as isize) as ::core::ffi::c_int
                                & 0x3f as ::core::ffi::c_int)
                            as ::core::ffi::c_ulong;
                        n = n.wrapping_sub(0x10000 as ::core::ffi::c_ulong);
                        *to.offset(0 as isize) = (n >> 10 as ::core::ffi::c_int
                            | 0xd800 as ::core::ffi::c_ulong)
                            as ::core::ffi::c_ushort;
                        *to.offset(1 as isize) = (n & 0x3ff as ::core::ffi::c_ulong
...
unsafe extern "C" fn little2_toUtf8(
    ...
    let mut from: *const ::core::ffi::c_char = *fromP;
    fromLim = from.offset(
        ((fromLim.offset_from(from) >> 1 as ::core::ffi::c_int) << 1 as ::core::ffi::c_int)
            as isize,
    );
    while from < fromLim {
        let mut plane: ::core::ffi::c_int = 0;
        let mut lo2: ::core::ffi::c_uchar = 0;
        let mut lo: ::core::ffi::c_uchar = *from.offset(0 as isize) as ::core::ffi::c_uchar;
        let mut hi: ::core::ffi::c_uchar = *from.offset(1 as isize) as ::core::ffi::c_uchar;
        's_169: {
            match hi as ::core::ffi::c_int {
                0 => {
                    if (lo as ::core::ffi::c_int) < 0x80 as ::core::ffi::c_int {
                        ...
                        let c2rust_fresh11 = *toP;
                        *toP = (*toP).offset(1);
                        *c2rust_fresh11 = lo as ::core::ffi::c_char;
                        break 's_169;
                    }
                }
                1 | 2 | 3 | 4 | 5 | 6 | 7 => {}
                216 | 217 | 218 | 219 => {
                    if toLim.offset_from(*toP) < 4 as isize {
                        *fromP = from;
                        return crate::src::xmltok::XML_CONVERT_OUTPUT_EXHAUSTED;
                    }
                    if fromLim.offset_from(from) < 4 as isize {
                        *fromP = from;
                        return crate::src::xmltok::XML_CONVERT_INPUT_INCOMPLETE;
                    }
                    plane = ((hi as ::core::ffi::c_int & 0x3 as ::core::ffi::c_int)
                        ...
                        + 1 as ::core::ffi::c_int;
                    let c2rust_fresh17 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh17 = (plane >> 2 as ::core::ffi::c_int
                        | UTF8_cval4 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh18 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh18 = (lo as ::core::ffi::c_int >> 2 as ::core::ffi::c_int
                        & 0xf as ::core::ffi::c_int
                        | (plane & 0x3 as ::core::ffi::c_int) << 4 as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    from = from.offset(2 as ::core::ffi::c_int as isize);
                    lo2 = *from.offset(0 as isize) as ::core::ffi::c_uchar;
                    let c2rust_fresh19 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh19 = ((lo as ::core::ffi::c_int & 0x3 as ::core::ffi::c_int)
                        << 4 as ::core::ffi::c_int
                        | (*from.offset(1 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int
                            & 0x3 as ::core::ffi::c_int)
                            << 2 as ::core::ffi::c_int
                    ...
                    *toP = (*toP).offset(1);
                    *c2rust_fresh20 = (lo2 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    break 's_169;
                }
                _ => {
                    if toLim.offset_from(*toP) < 3 as isize {
                        *fromP = from;
                        return crate::src::xmltok::XML_CONVERT_OUTPUT_EXHAUSTED;
                    }
                    let c2rust_fresh14 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh14 = (hi as ::core::ffi::c_int >> 4 as ::core::ffi::c_int
                        | UTF8_cval3 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh15 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh15 = ((hi as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                        << 2 as ::core::ffi::c_int
                        | lo as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh16 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh16 = (lo as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    break 's_169;
                }
            ...
            let c2rust_fresh12 = *toP;
            *toP = (*toP).offset(1);
            *c2rust_fresh12 = (lo as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                | (hi as ::core::ffi::c_int) << 2 as ::core::ffi::c_int
                | UTF8_cval2 as ::core::ffi::c_int)
                as ::core::ffi::c_char;
            let c2rust_fresh13 = *toP;
            *toP = (*toP).offset(1);
            *c2rust_fresh13 = (lo as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                | 0x80 as ::core::ffi::c_int) as ::core::ffi::c_char;
        }
        from = from.offset(2 as ::core::ffi::c_int as isize);
    }
...
unsafe extern "C" fn big2_toUtf8(
    ...
    while from < fromLim {
        let mut plane: ::core::ffi::c_int = 0;
        let mut lo2: ::core::ffi::c_uchar = 0;
        let mut lo: ::core::ffi::c_uchar = *from.offset(1 as isize) as ::core::ffi::c_uchar;
        let mut hi: ::core::ffi::c_uchar = *from.offset(0 as isize) as ::core::ffi::c_uchar;
        's_169: {
            match hi as ::core::ffi::c_int {
                0 => {
                    if (lo as ::core::ffi::c_int) < 0x80 as ::core::ffi::c_int {
                        ...
                        *toP = (*toP).offset(1);
                        *c2rust_fresh22 = lo as ::core::ffi::c_char;
                        break 's_169;
                    }
                }
                1 | 2 | 3 | 4 | 5 | 6 | 7 => {}
                216 | 217 | 218 | 219 => {
                    ...
                    *toP = (*toP).offset(1);
                    *c2rust_fresh28 = (plane >> 2 as ::core::ffi::c_int
                        | UTF8_cval4 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh29 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh29 = (lo as ::core::ffi::c_int >> 2 as ::core::ffi::c_int
                        & 0xf as ::core::ffi::c_int
                        | (plane & 0x3 as ::core::ffi::c_int) << 4 as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    from = from.offset(2 as ::core::ffi::c_int as isize);
                    lo2 = *from.offset(1 as isize) as ::core::ffi::c_uchar;
                    let c2rust_fresh30 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh30 = ((lo as ::core::ffi::c_int & 0x3 as ::core::ffi::c_int)
                        << 4 as ::core::ffi::c_int
                        | (*from.offset(0 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int
                            & 0x3 as ::core::ffi::c_int)
                            << 2 as ::core::ffi::c_int
                        | lo2 as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh31 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh31 = (lo2 as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    break 's_169;
                }
                _ => {
                    ...
                    *toP = (*toP).offset(1);
                    *c2rust_fresh25 = (hi as ::core::ffi::c_int >> 4 as ::core::ffi::c_int
                        | UTF8_cval3 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    let c2rust_fresh26 = *toP;
                    *toP = (*toP).offset(1);
                    *c2rust_fresh26 = ((hi as ::core::ffi::c_int & 0xf as ::core::ffi::c_int)
                        << 2 as ::core::ffi::c_int
                        | lo as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    ...
                    *toP = (*toP).offset(1);
                    *c2rust_fresh27 = (lo as ::core::ffi::c_int & 0x3f as ::core::ffi::c_int
                        | 0x80 as ::core::ffi::c_int)
                        as ::core::ffi::c_char;
                    break 's_169;
                }
            ...
            *toP = (*toP).offset(1);
            *c2rust_fresh23 = (lo as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                | (hi as ::core::ffi::c_int) << 2 as ::core::ffi::c_int
                | UTF8_cval2 as ::core::ffi::c_int)
                as ::core::ffi::c_char;
...
pub unsafe extern "C" fn XmlInitUnknownEncoding(
    ...
    while i < 256 as ::core::ffi::c_int {
        ...
        if c == -1 as ::core::ffi::c_int {
            ...
            (*e).utf8[i as usize][0 as usize] = 1 as ::core::ffi::c_char;
            (*e).utf8[i as usize][1 as usize] = 0 as ::core::ffi::c_char;
            ...
            (*e).normal.type_0[i as usize] = (crate::xmltok_impl_h::BT_LEAD2 as ::core::ffi::c_int
                ...
                as ::core::ffi::c_uchar;
            (*e).utf8[i as usize][0 as usize] = 0 as ::core::ffi::c_char;
            ...
            (*e).utf8[i as usize][0 as usize] = 1 as ::core::ffi::c_char;
            (*e).utf8[i as usize][1 as usize] = c as ::core::ffi::c_char;
            ...
            (*e).utf8[i as usize][0 as usize] = XmlUtf8Encode(
                c,
    ...
    (*e).normal.enc.utf16Convert = Utf16Converter::Unknown;
...
unsafe extern "C" fn initScan(
    ...
    if ptr.offset(1 as ::core::ffi::c_int as isize) == end {
        ...
        's_181: {
            match (*ptr.offset(0 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int)
                << 8 as ::core::ffi::c_int
                | *ptr.offset(1 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int
            {
                65279 => {
                        ...
                        && state == crate::src::xmltok::XML_CONTENT_STATE)
                    {
                        *encPtr =
                        ...
                        return (**encPtr).scanners[state as usize]
                            .scan(*encPtr, ptr, end, nextTokPtr);
                    }
                }
                65534 => {
                    if !((*enc).initEnc.isUtf16 as ::core::ffi::c_int
                ...
                61371 => {
                    ...
                    if *ptr.offset(2 as isize) as ::core::ffi::c_uchar as ::core::ffi::c_int
                        == 0xbf as ::core::ffi::c_int
                    {
                        *nextTokPtr = ptr.offset(3 as ::core::ffi::c_int as isize);
                        *encPtr = *encodingTable.offset(UTF_8_ENC as ::core::ffi::c_int as isize);
                        return crate::src::xmltok::XML_TOK_BOM_1;
                    }
                }
                _ => {
                    ...
                    } else if *ptr.offset(1 as isize) as ::core::ffi::c_int
                        == '\0' as ::core::ffi::c_int
                    {
                        if state != crate::src::xmltok::XML_CONTENT_STATE {
                            *encPtr =
    ...
    *encPtr = *encodingTable.offset((*enc).initEnc.isUtf16 as ::core::ffi::c_int as isize);
    return (**encPtr).scanners[state as usize].scan(*encPtr, ptr, end, nextTokPtr);
}
