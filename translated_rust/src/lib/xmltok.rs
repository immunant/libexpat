...
macro_rules! with_ref {
    ($ptr:expr, |$value:ident| $body:expr $(,)?) => {{
        let ptr = $ptr;
...
fn scan_utf16_prolog_tok_with(
    enc: *const ENCODING,
    mut ptr: *const ::core::ffi::c_char,
    end: *const ::core::ffi::c_char,
    next_tok_ptr: *mut *const ::core::ffi::c_char,
    byte_type: ByteTypeReader,
    scan_lit: extern "C" fn(
        ::core::ffi::c_int,
        *const ENCODING,
        *const ::core::ffi::c_char,
        *const ::core::ffi::c_char,
    ...
    scan_decl: TokenScanner,
    scan_pi: TokenScanner,
    scan_percent: TokenScanner,
    scan_pound_name: TokenScanner,
    is_ascii: AsciiMatcher,
    is_name_start: fn(*const ::core::ffi::c_char) -> bool,
    is_name_char: fn(*const ::core::ffi::c_char) -> bool,
) -> ::core::ffi::c_int {
    ...
    match byte_type(enc, ptr) {
        value if value == BT_QUOT as ::core::ffi::c_int => {
            return scan_lit(
                BT_QUOT as ::core::ffi::c_int,
                enc,
                add_const_c_char(ptr, unit_offset),
                end,
                next_tok_ptr,
            );
        }
        value if value == BT_APOS as ::core::ffi::c_int => {
            return scan_lit(
        ...
        value if value == BT_LT as ::core::ffi::c_int => {
            ...
            match byte_type(enc, ptr) {
                value if value == BT_EXCL as ::core::ffi::c_int => {
                    return scan_decl(enc, add_const_c_char(ptr, unit_offset), end, next_tok_ptr);
                }
                value if value == BT_QUEST as ::core::ffi::c_int => {
                    return scan_pi(enc, add_const_c_char(ptr, unit_offset), end, next_tok_ptr);
                }
                value
                    if value == BT_NMSTRT as ::core::ffi::c_int
                        || value == BT_HEX as ::core::ffi::c_int
                        || value == BT_NONASCII as ::core::ffi::c_int
                        || value == BT_LEAD2 as ::core::ffi::c_int
                        || value == BT_LEAD3 as ::core::ffi::c_int
                        || value == BT_LEAD4 as ::core::ffi::c_int =>
                {
                    set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, -unit_offset));
        ...
        value if value == BT_CR as ::core::ffi::c_int => {
            if add_const_c_char(ptr, unit_offset) == end {
                set_next_token_ptr(next_tok_ptr, end);
                return -XML_TOK_PROLOG_S;
            }
        }
        value if value == BT_S as ::core::ffi::c_int || value == BT_LF as ::core::ffi::c_int => {}
        value if value == BT_PERCNT as ::core::ffi::c_int => {
            return scan_percent(enc, add_const_c_char(ptr, unit_offset), end, next_tok_ptr);
        }
        value if value == BT_COMMA as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
            return XML_TOK_COMMA;
        }
        value if value == BT_LSQB as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
        ...
        value if value == BT_RSQB as ::core::ffi::c_int => {
            ...
            if is_ascii(ptr, b']') {
                if !has_c_chars(ptr, end, 2 * unit_size) {
                    return XML_TOK_PARTIAL;
                }
                if is_ascii(add_const_c_char(ptr, unit_offset), b'>') {
                    set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, 2 * unit_offset));
        ...
        value if value == BT_LPAR as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
            return XML_TOK_OPEN_PAREN;
        }
        value if value == BT_RPAR as ::core::ffi::c_int => {
            ptr = add_const_c_char(ptr, unit_offset);
            if !has_c_chars(ptr, end, unit_size) {
                return -XML_TOK_CLOSE_PAREN;
            }
            match byte_type(enc, ptr) {
                value if value == BT_AST as ::core::ffi::c_int => {
                    set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
                ...
                value if value == BT_PLUS as ::core::ffi::c_int => {
                    set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
                    return XML_TOK_CLOSE_PAREN_PLUS;
                }
                value
                    if value == BT_CR as ::core::ffi::c_int
                        || value == BT_LF as ::core::ffi::c_int
                        || value == BT_S as ::core::ffi::c_int
                        || value == BT_GT as ::core::ffi::c_int
                        || value == BT_COMMA as ::core::ffi::c_int
                        || value == BT_VERBAR as ::core::ffi::c_int
                        || value == BT_RPAR as ::core::ffi::c_int =>
                {
                    set_next_token_ptr(next_tok_ptr, ptr);
                    return XML_TOK_CLOSE_PAREN;
                }
        ...
        value if value == BT_VERBAR as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
            return XML_TOK_OR;
        }
        value if value == BT_GT as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_offset));
            return XML_TOK_DECL_CLOSE;
        }
        value if value == BT_NUM as ::core::ffi::c_int => {
            return scan_pound_name(enc, add_const_c_char(ptr, unit_offset), end, next_tok_ptr);
        }
        value if value == BT_NONASCII as ::core::ffi::c_int => {
            if is_name_start(ptr) {
                tok = XML_TOK_NAME;
        ...
        value
            if value == BT_DIGIT as ::core::ffi::c_int
                || value == BT_NAME as ::core::ffi::c_int
                || value == BT_MINUS as ::core::ffi::c_int =>
        {
            tok = XML_TOK_NMTOKEN;
    ...
    while has_c_chars(ptr, end, unit_size) {
        match byte_type(enc, ptr) {
            value
                if value == BT_NONASCII as ::core::ffi::c_int
                    || value == BT_NMSTRT as ::core::ffi::c_int
                    || value == BT_HEX as ::core::ffi::c_int
                    || value == BT_DIGIT as ::core::ffi::c_int
                    || value == BT_NAME as ::core::ffi::c_int
                    || value == BT_MINUS as ::core::ffi::c_int
                    ...
                    || value == BT_LEAD4 as ::core::ffi::c_int =>
            {
                ptr = match advance_name_char_with(
                    enc,
                    ptr,
                    end,
                    unit_size,
                    ...
                    NameScanResult::Advanced(next_ptr) => next_ptr,
                    NameScanResult::Partial => return XML_TOK_PARTIAL,
                    NameScanResult::PartialChar => return XML_TOK_PARTIAL_CHAR,
                    NameScanResult::Invalid => {
                        set_next_token_ptr(next_tok_ptr, ptr);
                        return XML_TOK_INVALID;
                    }
                };
            ...
            value
                if value == BT_GT as ::core::ffi::c_int
                    || value == BT_RPAR as ::core::ffi::c_int
                    || value == BT_COMMA as ::core::ffi::c_int
                    || value == BT_VERBAR as ::core::ffi::c_int
            ...
            value if value == BT_COLON_0 as ::core::ffi::c_int => {
                ptr = add_const_c_char(ptr, unit_offset);
                match tok {
                    XML_TOK_NAME => {
                        if !has_c_chars(ptr, end, unit_size) {
...
fn scan_normal_end_tag_with(
    ...
    let token_type = normal_byte_type(enc, ptr);
    ptr = match token_type {
        value if value == BT_NONASCII as ::core::ffi::c_int => {
            set_next_token_ptr(next_tok_ptr, ptr);
            return XML_TOK_INVALID;
                ...
                || value == BT_LEAD4 as ::core::ffi::c_int =>
        {
            ...
            if !normal_name_start_seq_valid(enc, width, ptr) {
                set_next_token_ptr(next_tok_ptr, ptr);
                return XML_TOK_INVALID;
            }
            add_const_c_char(ptr, width as isize)
        }
        _ => {
            set_next_token_ptr(next_tok_ptr, ptr);
            return XML_TOK_INVALID;
    ...
    while has_c_chars(ptr, end, 1) {
        ...
        ptr = match token_type {
                    ...
                    || value == BT_LEAD4 as ::core::ffi::c_int =>
            {
                ...
                if !normal_name_char_seq_valid(enc, width, ptr) {
                    set_next_token_ptr(next_tok_ptr, ptr);
                    return XML_TOK_INVALID;
                }
                add_const_c_char(ptr, width as isize)
            ...
            value if value == BT_COLON_0 as ::core::ffi::c_int => add_const_c_char(ptr, 1),
            value if value == BT_GT as ::core::ffi::c_int => {
                set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, 1));
                return XML_TOK_END_TAG;
            }
...
fn scan_utf16_end_tag_with(
    ...
    while has_c_chars(ptr, end, 2) {
        ...
        ptr = match token_type {
            ...
            value if value == BT_COLON_0 as ::core::ffi::c_int => add_const_c_char(ptr, 2),
            value if value == BT_GT as ::core::ffi::c_int => {
                set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, 2));
                return XML_TOK_END_TAG;
            }
...
fn scan_atts_with(
    ...
    nonascii_name_start: fn(*const ::core::ffi::c_char) -> bool,
    nonascii_name_char: fn(*const ::core::ffi::c_char) -> bool,
    multibyte_name_start: MultibyteValidator,
    multibyte_name_char: MultibyteValidator,
    value_multibyte_valid: MultibyteValidator,
    scan_ref: TokenScanner,
    is_ascii: AsciiMatcher,
) -> ::core::ffi::c_int {
    let unit_offset = unit_size as isize;
    let mut had_colon = false;

    'scan: while has_c_chars(ptr, end, unit_size) {
        match byte_type(enc, ptr) {
            value if value == BT_NONASCII as ::core::ffi::c_int => {
                if !nonascii_name_char(ptr) {
                    set_next_token_ptr(next_tok_ptr, ptr);
            ...
            value
                if value == BT_S as ::core::ffi::c_int
                    || value == BT_CR as ::core::ffi::c_int
                    || value == BT_LF as ::core::ffi::c_int
                    || value == BT_EQUALS as ::core::ffi::c_int =>
            {
                if value != BT_EQUALS as ::core::ffi::c_int {
                    loop {
                        ptr = add_const_c_char(ptr, unit_offset);
                        if !has_c_chars(ptr, end, unit_size) {
                            return XML_TOK_PARTIAL;
                        ...
                        let token_type = byte_type(enc, ptr);
                        if token_type == BT_EQUALS as ::core::ffi::c_int {
                            break;
                        }
                        match token_type {
                            value
                ...
                loop {
                    ...
                    match byte_type(enc, ptr) {
                                ...
                                || value == BT_LEAD4 as ::core::ffi::c_int =>
                        {
                            ...
                            if !value_multibyte_valid(enc, width, ptr) {
                                set_next_token_ptr(next_tok_ptr, ptr);
                                return XML_TOK_INVALID;
                            }
                            ptr = add_const_c_char(ptr, width as isize);
                        ...
                        value if value == BT_AMP as ::core::ffi::c_int => {
                            let tok =
                                scan_ref(enc, add_const_c_char(ptr, unit_offset), end, &mut ptr);
                            if tok <= 0 {
                ...
                match byte_type(enc, ptr) {
                    ...
                    value if value == BT_SOL as ::core::ffi::c_int => {
                        ptr = add_const_c_char(ptr, unit_offset);
                        if !has_c_chars(ptr, end, unit_size) {
                            return XML_TOK_PARTIAL;
                        }
...
extern "C" fn normal_scanEndTag(
    ...
    scan_normal_end_tag_with(enc, ptr, end, nextTokPtr)
}
...
enum NameScanResult {
    Advanced(*const ::core::ffi::c_char),
    Partial,
    PartialChar,
    Invalid,
}

fn advance_name_start_with(
    enc: *const ENCODING,
    ptr: *const ::core::ffi::c_char,
    end: *const ::core::ffi::c_char,
    unit_size: usize,
    ...
    match token_type {
        value if value == BT_NONASCII as ::core::ffi::c_int => {
            if nonascii_name_start(ptr) {
                NameScanResult::Advanced(add_const_c_char(ptr, unit_size as isize))
            } else {
                NameScanResult::Invalid
            }
        }
                ...
                || value == BT_LEAD4 as ::core::ffi::c_int =>
        {
            let width = multibyte_sequence_len(token_type);
            if !has_c_chars(ptr, end, width) {
                NameScanResult::PartialChar
            } else if multibyte_name_start(enc, width, ptr) {
                NameScanResult::Advanced(add_const_c_char(ptr, width as isize))
            } else {
                NameScanResult::Invalid
            }
        }
        _ => NameScanResult::Invalid,
    }
}

fn advance_name_char_with(
    enc: *const ENCODING,
    ptr: *const ::core::ffi::c_char,
    end: *const ::core::ffi::c_char,
    unit_size: usize,
    ...
    match token_type {
                ...
                || value == BT_LEAD4 as ::core::ffi::c_int =>
        {
            ...
            if !has_c_chars(ptr, end, width) {
                NameScanResult::PartialChar
            } else if multibyte_name_char(enc, width, ptr) {
                NameScanResult::Advanced(add_const_c_char(ptr, width as isize))
            } else {
                NameScanResult::Invalid
            }
...
fn scan_lt_with(
    ...
    multibyte_name_start: MultibyteValidator,
    multibyte_name_char: MultibyteValidator,
    scan_comment: TokenScanner,
    scan_cdata_section: TokenScanner,
    scan_pi: TokenScanner,
    scan_end_tag: TokenScanner,
    scan_atts: TokenScanner,
    is_ascii: AsciiMatcher,
) -> ::core::ffi::c_int {
    let unit_offset = unit_size as isize;
    ...
    ptr = match byte_type(enc, ptr) {
        value if value == BT_EXCL as ::core::ffi::c_int => {
            let bang = add_const_c_char(ptr, unit_offset);
            if !has_c_chars(bang, end, unit_size) {
                return XML_TOK_PARTIAL;
            }
            return match byte_type(enc, bang) {
                value if value == BT_MINUS as ::core::ffi::c_int => {
                    scan_comment(enc, add_const_c_char(bang, unit_offset), end, next_tok_ptr)
                }
                value if value == BT_LSQB as ::core::ffi::c_int => {
                    scan_cdata_section(enc, add_const_c_char(bang, unit_offset), end, next_tok_ptr)
                }
                _ => {
                    set_next_token_ptr(next_tok_ptr, bang);
                    XML_TOK_INVALID
                }
            };
        }
        ...
        value if value == BT_SOL as ::core::ffi::c_int => {
            return scan_end_tag(enc, add_const_c_char(ptr, unit_offset), end, next_tok_ptr);
        }
        _ => match advance_name_start_with(
            enc,
            ptr,
            end,
            unit_size,
    ...
    while has_c_chars(ptr, end, unit_size) {
        ...
        match token_type {
            ...
            value if value == BT_COLON_0 as ::core::ffi::c_int => {
                ...
                ptr = match advance_name_start_with(
                    enc,
                    ptr,
                    end,
                    unit_size,
                    ...
                    || value == BT_LF as ::core::ffi::c_int =>
            {
                ...
                while has_c_chars(ptr, end, unit_size) {
                    ...
                    match token_type {
                        ...
                        value if value == BT_SOL as ::core::ffi::c_int => {
                            let slash = add_const_c_char(ptr, unit_offset);
                            if !has_c_chars(slash, end, unit_size) {
                                return XML_TOK_PARTIAL;
                            }
                            if !is_ascii(slash, b'>') {
                                set_next_token_ptr(next_tok_ptr, slash);
                                return XML_TOK_INVALID;
                            }
                            set_next_token_ptr(next_tok_ptr, add_const_c_char(slash, unit_offset));
        ...
        match byte_type(enc, ptr) {
            ...
            value if value == BT_CR as ::core::ffi::c_int => {
                if ptr == start {
                    ...
                    if byte_type(enc, ptr) == BT_LF as ::core::ffi::c_int {
                        ptr = add_const_c_char(ptr, unit_size as isize);
                    }
                    set_next_token_ptr(next_tok_ptr, ptr);
                    return XML_TOK_DATA_NEWLINE;
            ...
            value if value == BT_S as ::core::ffi::c_int => {
                if ptr == start {
                    set_next_token_ptr(next_tok_ptr, add_const_c_char(ptr, unit_size as isize));
...
extern "C" fn normal_prologTok(
    ...
    match normal_byte_type(enc, ptr) {
        ...
        2 => {
            ...
            match normal_byte_type(enc, ptr) {
                16 => return normal_scanDecl(enc, add_const_c_char(ptr, 1), end, nextTokPtr),
                15 => return normal_scanPi(enc, add_const_c_char(ptr, 1), end, nextTokPtr),
                22 | 24 | 29 | 5 | 6 | 7 => {
                    set_next_token_ptr(nextTokPtr, add_const_c_char(ptr, -1));
                    return XML_TOK_INSTANCE_START;
                }
                _ => {}
            }
            set_next_token_ptr(nextTokPtr, ptr);
            return XML_TOK_INVALID;
        }
        9 => {
            if add_const_c_char(ptr, 1) == end {
                set_next_token_ptr(nextTokPtr, end);
                return -XML_TOK_PROLOG_S;
            }
            in_prolog_space = true;
        }
        21 | 10 => {
            in_prolog_space = true;
        }
        30 => {
            return normal_scanPercent(enc, add_const_c_char(ptr, 1), end, nextTokPtr);
        }
        35 => {
            set_next_token_ptr(nextTokPtr, add_const_c_char(ptr, 1));
            return XML_TOK_COMMA;
        ...
        4 => {
            ...
            if read_c_char(ptr) as ::core::ffi::c_int == ']' as i32 {
                if remaining_const_c_chars(ptr, end) < 2 {
                    return XML_TOK_PARTIAL;
                }
                if read_c_char(add_const_c_char(ptr, 1)) as ::core::ffi::c_int == '>' as i32 {
                    set_next_token_ptr(nextTokPtr, add_const_c_char(ptr, 2));
                    return XML_TOK_COND_SECT_CLOSE;
                }
            }
            set_next_token_ptr(nextTokPtr, ptr);
        ...
        19 => {
            return normal_scanPoundName(enc, add_const_c_char(ptr, 1), end, nextTokPtr);
        }
        5 => {
            if remaining_const_c_chars(ptr, end) < 2 {
                return XML_TOK_PARTIAL_CHAR;
            ...
            if normal_is_name_start(enc, 2, ptr) != 0 {
                ptr = add_const_c_char(ptr, 2);
                tok = XML_TOK_NAME;
            } else if normal_is_name_char(enc, 2, ptr) != 0 {
                ptr = add_const_c_char(ptr, 2);
                tok = XML_TOK_NMTOKEN;
            } else {
                set_next_token_ptr(nextTokPtr, ptr);
        ...
        6 => {
            if remaining_const_c_chars(ptr, end) < 3 {
                return XML_TOK_PARTIAL_CHAR;
            }
            if normal_is_invalid(enc, 3, ptr) != 0 {
                set_next_token_ptr(nextTokPtr, ptr);
            ...
            if normal_is_name_start(enc, 3, ptr) != 0 {
                ptr = add_const_c_char(ptr, 3);
                tok = XML_TOK_NAME;
            } else if normal_is_name_char(enc, 3, ptr) != 0 {
                ptr = add_const_c_char(ptr, 3);
                tok = XML_TOK_NMTOKEN;
            } else {
                set_next_token_ptr(nextTokPtr, ptr);
        ...
        7 => {
            if remaining_const_c_chars(ptr, end) < 4 {
                return XML_TOK_PARTIAL_CHAR;
            }
            if normal_is_invalid(enc, 4, ptr) != 0 {
                set_next_token_ptr(nextTokPtr, ptr);
            ...
            if normal_is_name_start(enc, 4, ptr) != 0 {
                ptr = add_const_c_char(ptr, 4);
                tok = XML_TOK_NAME;
            } else if normal_is_name_char(enc, 4, ptr) != 0 {
                ptr = add_const_c_char(ptr, 4);
                tok = XML_TOK_NMTOKEN;
            } else {
                set_next_token_ptr(nextTokPtr, ptr);
    ...
    if in_prolog_space {
        loop {
            ...
            match normal_byte_type(enc, ptr) {
                21 | 10 => {}
                9 if add_const_c_char(ptr, 1) != end => {}
                _ => {
                    set_next_token_ptr(nextTokPtr, ptr);
                    return XML_TOK_PROLOG_S;
                }
                    ...
                    XML_TOK_NAME => {
                        ...
                        match normal_byte_type(enc, ptr) {
                            ...
                            5 => {
                                ...
                                if normal_is_invalid(enc, 2, ptr) != 0
                                    || normal_is_name_char(enc, 2, ptr) == 0
                                {
                                    set_next_token_ptr(nextTokPtr, ptr);
                                    return XML_TOK_INVALID;
                                }
                            ...
                            6 => {
                                ...
                                if normal_is_invalid(enc, 3, ptr) != 0
                                    || normal_is_name_char(enc, 3, ptr) == 0
                                {
                                    set_next_token_ptr(nextTokPtr, ptr);
                                    return XML_TOK_INVALID;
                                }
                            ...
                            7 => {
                                ...
                                if normal_is_invalid(enc, 4, ptr) != 0
                                    || normal_is_name_char(enc, 4, ptr) == 0
                                {
                                    set_next_token_ptr(nextTokPtr, ptr);
                                    return XML_TOK_INVALID;
                                }
...
extern "C" fn little2_contentTok(
    ...
    let aligned_end = even_c_char_boundary(ptr, end);
    if aligned_end != end {
        if aligned_end == ptr {
            return XML_TOK_PARTIAL;
        }
    ...
    ptr = match little2_byte_type(enc, ptr) {
        2 => {
            return little2_scanLt(enc, add_const_c_char(ptr, 2), end, nextTokPtr);
        }
        3 => {
            return little2_scanRef(enc, add_const_c_char(ptr, 2), end, nextTokPtr);
        }
        9 => {
            ptr = add_const_c_char(ptr, 2);
            if !has_c_chars(ptr, end, 2) {
            ...
            if little2_byte_type(enc, ptr) == BT_LF as ::core::ffi::c_int {
                ptr = add_const_c_char(ptr, 2);
            }
            set_const_c_char_ptr(nextTokPtr, ptr);
            return XML_TOK_DATA_NEWLINE;
    ...
    while has_c_chars(ptr, end, 2) {
        ptr = match little2_byte_type(enc, ptr) {
            ...
            4 => {
                if has_c_chars(ptr, end, 4) {
                    let second_rsqb = add_const_c_char(ptr, 2);
                    if !little2_is_ascii(second_rsqb, b']') {
                        second_rsqb
                    } else if has_c_chars(ptr, end, 6) {
                        let gt = add_const_c_char(ptr, 4);
                        if !little2_is_ascii(gt, b'>') {
                            second_rsqb
                        } else {
                            set_const_c_char_ptr(nextTokPtr, gt);
                            return XML_TOK_INVALID;
                        }
                    } else {
                        set_const_c_char_ptr(nextTokPtr, ptr);
...
extern "C" fn big2_contentTok(
    ...
    ptr = match big2_byte_type(enc, ptr) {
        2 => {
            return big2_scanLt(enc, add_const_c_char(ptr, 2), end, nextTokPtr);
        }
        3 => {
            return big2_scanRef(enc, add_const_c_char(ptr, 2), end, nextTokPtr);
        }
        9 => {
            ptr = add_const_c_char(ptr, 2);
            if !has_c_chars(ptr, end, 2) {
            ...
            if big2_byte_type(enc, ptr) == BT_LF as ::core::ffi::c_int {
                ptr = add_const_c_char(ptr, 2);
            }
            set_const_c_char_ptr(nextTokPtr, ptr);
            return XML_TOK_DATA_NEWLINE;
    ...
    while has_c_chars(ptr, end, 2) {
        ptr = match big2_byte_type(enc, ptr) {
            ...
            4 => {
                if has_c_chars(ptr, end, 4) {
                    let second_rsqb = add_const_c_char(ptr, 2);
                    if !big2_is_ascii(second_rsqb, b']') {
                        second_rsqb
                    } else if has_c_chars(ptr, end, 6) {
                        let gt = add_const_c_char(ptr, 4);
                        if !big2_is_ascii(gt, b'>') {
                            second_rsqb
                        } else {
                            set_const_c_char_ptr(nextTokPtr, gt);
                            return XML_TOK_INVALID;
...
extern "C" fn big2_attributeValueTok(
    ...
    attribute_value_tok_with(enc, ptr, end, nextTokPtr, 2, big2_byte_type, big2_scanRef)
}
