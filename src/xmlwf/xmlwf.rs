...
use ::core::ffi::{c_char, c_float, c_int, c_long, c_longlong, c_uint, c_ulonglong, c_void};
...
pub mod stdlib {
    ...
    use ::core::ffi::{c_char, c_float, c_int, c_long, c_ulonglong, c_void};
    ...
    extern "C" {
        ...
        pub fn strtof(__nptr: *const c_char, __endptr: *mut *mut c_char) -> c_float;
...
unsafe extern "C" fn characterData(
    ...
    while len > 0 {
        match *s as c_int {
            ...
            9 | 10 | 13 => {
                fprintf(fp, b"&#%d;\0" as *const u8 as *const c_char, *s as c_int);
            }
            _ => {
                putc(*s as c_int, fp);
            }
...
unsafe extern "C" fn startElement(
    ...
    if nAtts > 1 {
        qsort(
            atts as *mut c_void,
            nAtts as size_t,
            (size_of::<*mut XML_Char>()).wrapping_mul(2usize),
            Some(attcmp as unsafe extern "C" fn(*const c_void, *const c_void) -> c_int),
        );
    }
    while !(*atts).is_null() {
        putc(' ' as i32, fp);
...
unsafe extern "C" fn nsattcmp(mut p1: *const c_void, mut p2: *const c_void) -> c_int {
    ...
    let mut sep1: c_int =
        (::expat::stdlib::strrchr(att1, '\u{1}' as i32) != null_mut::<c_char>()) as c_int;
    let mut sep2: c_int =
        (::expat::stdlib::strrchr(att2, '\u{1}' as i32) != null_mut::<c_char>()) as c_int;
    if sep1 != sep2 {
        return sep1 - sep2;
    }
...
unsafe extern "C" fn startElementNS(
    ...
    if !sep.is_null() {
        fputs(b"n1:\0" as *const u8 as *const c_char, fp);
        fputs(sep.offset(1), fp);
        fputs(b" xmlns:n1\0" as *const u8 as *const c_char, fp);
    ...
    if nAtts > 1 {
        qsort(
            ...
            nAtts as size_t,
            (size_of::<*mut XML_Char>()).wrapping_mul(2usize),
            Some(nsattcmp as unsafe extern "C" fn(*const c_void, *const c_void) -> c_int),
        );
    }
    while !(*atts).is_null() {
        let fresh1 = atts;
        ...
        putc(' ' as i32, fp);
        if !sep.is_null() {
            fprintf(fp, b"n%d:\0" as *const u8 as *const c_char, nsi);
...
unsafe extern "C" fn xcsdup(mut s: *const XML_Char) -> *mut XML_Char {
    ...
    ::expat::stdlib::memcpy(result as *mut c_void, s as *const c_void, numBytes);
    return result;
}
...
unsafe extern "C" fn freeNotations(mut data: *mut XmlwfUserData) {
    ...
    (*data).notationListHead = null_mut::<NotationList>();
}

unsafe extern "C" fn cleanupUserData(mut userData: *mut XmlwfUserData) {
    free((*userData).currentDoctypeName as *mut c_void);
    (*userData).currentDoctypeName = null::<XML_Char>();
...
unsafe extern "C" fn endDoctypeDecl(mut userData: *mut c_void) {
    ...
    let mut p: *mut NotationList = null_mut::<NotationList>();
    let mut i: c_int = 0;
    ...
    if !(notationCount == 0) {
        notations = malloc((notationCount as size_t).wrapping_mul(size_of::<*mut NotationList>()))
            as *mut *mut NotationList;
        if notations.is_null() {
            fprintf(
                stderr,
                b"Unable to sort notations\0" as *const u8 as *const c_char,
            );
        } else {
            p = (*data).notationListHead;
            i = 0;
            ...
            qsort(
                ...
                Some(notationCmp as unsafe extern "C" fn(*const c_void, *const c_void) -> c_int),
            );
            fputs(b"<!DOCTYPE \0" as *const u8 as *const c_char, (*data).fp);
            fputs((*data).currentDoctypeName, (*data).fp);
            fputs(b" [\n\0" as *const u8 as *const c_char, (*data).fp);
            i = 0;
            while i < notationCount {
                fputs(b"<!NOTATION \0" as *const u8 as *const c_char, (*data).fp);
                fputs((**notations.offset(i as isize)).notationName, (*data).fp);
                if !(**notations.offset(i as isize)).publicId.is_null() {
                    fputs(b" PUBLIC '\0" as *const u8 as *const c_char, (*data).fp);
                    ...
                    fputs(b" SYSTEM '\0" as *const u8 as *const c_char, (*data).fp);
                    fputs((**notations.offset(i as isize)).systemId, (*data).fp);
                    putc('\'' as i32, (*data).fp);
                }
                putc('>' as i32, (*data).fp);
    ...
    (*data).currentDoctypeName = null::<XML_Char>();
}
...
unsafe extern "C" fn notationDecl(
    ...
    let mut data: *mut XmlwfUserData = userData as *mut XmlwfUserData;
    let mut entry: *mut NotationList = malloc(size_of::<NotationList>()) as *mut NotationList;
...
unsafe extern "C" fn metaLocation(mut parser: XML_Parser) {
    ...
    if !uri.is_null() {
        fprintf(fp, b" uri=\"%s\"\0" as *const u8 as *const c_char, uri);
    }
    fprintf(
        fp,
...
unsafe extern "C" fn metaStartElement(
    ...
    fprintf(
        fp,
        b"<starttag name=\"%s\"\0" as *const u8 as *const c_char,
        name,
    );
    metaLocation(parser);
    if !(*atts).is_null() {
        ...
        loop {
            fprintf(
                fp,
                b"<attribute name=\"%s\" value=\"\0" as *const u8 as *const c_char,
                *atts.offset(0isize),
            );
            characterData(
                data as *mut c_void,
                *atts.offset(1),
                ::expat::stdlib::strlen(*atts.offset(1)) as c_int,
            );
...
unsafe extern "C" fn metaEndElement(mut userData: *mut c_void, mut name: *const XML_Char) {
    ...
    fprintf(
        fp,
        b"<endtag name=\"%s\"\0" as *const u8 as *const c_char,
        name,
    );
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn metaProcessingInstruction(
    ...
    fprintf(
        fp,
        b"<pi target=\"%s\" data=\"\0" as *const u8 as *const c_char,
        target,
    );
    characterData(
        usrData as *mut c_void,
        data,
        ::expat::stdlib::strlen(data) as c_int,
    );
    putc('"' as i32, fp);
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn metaComment(mut userData: *mut c_void, mut data: *const XML_Char) {
    ...
    let mut usrData: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*usrData).fp;
    fputs(b"<comment data=\"\0" as *const u8 as *const c_char, fp);
    characterData(
        usrData as *mut c_void,
        data,
        ::expat::stdlib::strlen(data) as c_int,
...
unsafe extern "C" fn metaStartCdataSection(mut userData: *mut c_void) {
    ...
    let mut data: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*data).fp;
    fputs(b"<startcdata\0" as *const u8 as *const c_char, fp);
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
}
...
unsafe extern "C" fn metaEndCdataSection(mut userData: *mut c_void) {
    ...
    let mut data: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*data).fp;
    fputs(b"<endcdata\0" as *const u8 as *const c_char, fp);
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
}
...
unsafe extern "C" fn metaCharacterData(
    ...
    let mut data: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*data).fp;
    fputs(b"<chars str=\"\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn metaStartDoctypeDecl(
    ...
    fprintf(
        fp,
        b"<startdoctype name=\"%s\"\0" as *const u8 as *const c_char,
        doctypeName,
    );
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn metaEndDoctypeDecl(mut userData: *mut c_void) {
    ...
    let mut data: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*data).fp;
    fputs(b"<enddoctype\0" as *const u8 as *const c_char, fp);
    metaLocation(parser);
    fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
}
...
unsafe extern "C" fn metaNotationDecl(
    ...
    fprintf(
        fp,
        b"<notation name=\"%s\"\0" as *const u8 as *const c_char,
        notationName,
    );
    if !publicId.is_null() {
        fprintf(
            fp,
            b" public=\"%s\"\0" as *const u8 as *const c_char,
            publicId,
        );
    }
    if !systemId.is_null() {
        fputs(b" system=\"\0" as *const u8 as *const c_char, fp);
        characterData(
            data as *mut c_void,
            systemId,
            ::expat::stdlib::strlen(systemId) as c_int,
        );
        putc('"' as i32, fp);
    }
    metaLocation(parser);
...
unsafe extern "C" fn metaEntityDecl(
    ...
    if !value.is_null() {
        fprintf(
            fp,
            b"<entity name=\"%s\"\0" as *const u8 as *const c_char,
            entityName,
        );
        metaLocation(parser);
        putc('>' as i32, fp);
        ...
        fprintf(
            fp,
            b" notation=\"%s\"\0" as *const u8 as *const c_char,
            notationName,
        );
        metaLocation(parser);
        fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn metaStartNamespaceDecl(
    ...
    let mut data: *mut XmlwfUserData = *(parser as *mut *mut c_void) as *mut XmlwfUserData;
    let mut fp: *mut FILE = (*data).fp;
    fputs(b"<startns\0" as *const u8 as *const c_char, fp);
    if !prefix.is_null() {
        fprintf(
            fp,
            b" prefix=\"%s\"\0" as *const u8 as *const c_char,
            prefix,
        );
    }
    if !uri.is_null() {
        fputs(b" ns=\"\0" as *const u8 as *const c_char, fp);
        characterData(
            data as *mut c_void,
            uri,
            ::expat::stdlib::strlen(uri) as c_int,
        );
        fputs(b"\"/>\n\0" as *const u8 as *const c_char, fp);
    } else {
        fputs(b"/>\n\0" as *const u8 as *const c_char, fp);
...
unsafe extern "C" fn unknownEncodingConvert(mut data: *mut c_void, mut p: *const c_char) -> c_int {
    return ::expat::src::xmlwf::codepage::codepageConvert(*(data as *mut c_int), p);
}
...
unsafe extern "C" fn unknownEncoding(
    ...
    while *name.offset(i as isize) != 0 {
        ...
        let mut s: *const XML_Char = crate::stdlib::strchr(
            ...
            *name.offset(i as isize) as c_int,
        );
        if s.is_null() {
            return 0i32;
        }
        cp *= 10;
        cp += s.offset_from(&raw const digits as *const XML_Char) as c_int;
        if cp >= 0x10000 {
            return 0i32;
        }
        i += 1;
    }
    if ::expat::src::xmlwf::codepage::codepageMap(cp, &raw mut (*info).map as *mut c_int) == 0 {
        return 0i32;
    }
    (*info).convert =
        Some(unknownEncodingConvert as unsafe extern "C" fn(*mut c_void, *const c_char) -> c_int);
    (*info).release = Some(free as unsafe extern "C" fn(*mut c_void) -> ());
    (*info).data = malloc(size_of::<c_int>());
...
unsafe extern "C" fn showVersion(mut prog: *mut XML_Char) {
    ...
    if !features.is_null() && (*features.offset(0)).feature != XML_FEATURE_END {
        ...
        if (*features.offset(0)).value != 0 {
            fprintf(
                stdout,
                b"=%ld\0" as *const u8 as *const c_char,
...
unsafe fn main_0(mut argc: c_int, mut argv: *mut *mut XML_Char) -> c_int {
    ...
    let mut attackMaximumAmplification: c_float = -1.0;
    let mut attackThresholdBytes: c_ulonglong = 0;
    ...
    while i < argc {
        if j == 0 {
            ...
            if *(*argv.offset(i as isize)).offset(1) as c_int == '-' as i32 {
                if *(*argv.offset(i as isize)).offset(2) as c_int == '\0' as i32 {
                    i += 1;
                    break;
                } else if strcmp(
                ...
                {
                    usage(*argv.offset(0isize), XMLWF_EXIT_SUCCESS as c_int);
                } else if strcmp(
                    (*argv.offset(i as isize)).offset(2),
        ...
        match *(*argv.offset(i as isize)).offset(j as isize) as c_int {
            ...
            100 => {
                if *(*argv.offset(i as isize)).offset((j + 1) as isize) as c_int == '\0' as i32 {
                    i += 1;
                    if i == argc {
                        usage(*argv.offset(0isize), XMLWF_EXIT_USAGE_ERROR as c_int);
                    }
            ...
            103 => {
                ...
                *::expat::stdlib::__errno_location() = 0;
                ...
                let read_size_bytes_candidate: c_longlong =
                    strtoull(valueText, &raw mut afterValueText, 10) as c_longlong;
                if *::expat::stdlib::__errno_location() != 0
                    || *afterValueText.offset(0) as c_int != '\0' as i32
                    ...
                    || read_size_bytes_candidate > (INT_MAX / 2 + 1) as c_longlong
                {
                    *::expat::stdlib::__errno_location() = ERANGE;
                    ...
                    exit(XMLWF_EXIT_USAGE_ERROR as c_int);
                }
                g_read_size_bytes = read_size_bytes_candidate as c_int;
                current_block_122 = 8602574157404971894;
            }
            107 => {
                continueOnError = 1;
            ...
            97 => {
                ...
                *::expat::stdlib::__errno_location() = 0;
                ...
                if *::expat::stdlib::__errno_location() != 0
                    || *afterValueText_0.offset(0) as c_int != '\0' as i32
            ...
            98 => {
                ...
                *::expat::stdlib::__errno_location() = 0;
                ...
                if *::expat::stdlib::__errno_location() != 0
                    || *afterValueText_1.offset(0) as c_int != '\0' as i32
                {
                    *::expat::stdlib::__errno_location() = ERANGE;
                    perror(
    ...
    while i < argc {
        ...
        if parser.is_null() {
            perror(b"Could not instantiate parser\0" as *const u8 as *const c_char);
        ...
        if disableDeferral != 0 {
            ...
            if success == 0 {
                *::expat::stdlib::__errno_location() = EINVAL;
                perror(b"Failed to disable reparse deferral\0" as *const u8 as *const c_char);
                exit(XMLWF_EXIT_INTERNAL_ERROR as c_int);
            }
        }
        if requireStandalone != 0 {
            XML_SetNotStandaloneHandler(
                parser,
                Some(notStandalone as unsafe extern "C" fn(*mut c_void) -> c_int),
            );
        }
        ...
        if outputType == 't' as i32 {
            ...
            XML_SetElementHandler(
                ...
                Some(nopEndElement as unsafe extern "C" fn(*mut c_void, *const XML_Char) -> ()),
            );
            XML_SetCharacterDataHandler(
                parser,
                Some(
                    nopCharacterData
                        as unsafe extern "C" fn(*mut c_void, *const XML_Char, c_int) -> (),
                ),
            );
            ...
            if useStdin == 0 {
                let mut lastDelim: *const XML_Char =
                    ::expat::stdlib::strrchr(file, *delim.offset(0) as c_int);
            ...
            if userData.fp.is_null() {
                ...
                setvbuf(userData.fp, null_mut::<c_char>(), _IOFBF, 16384);
                ...
                match outputType {
                    109 => {
                        ...
                        XML_SetElementHandler(
                            ...
                            Some(
                                metaEndElement
                                    as unsafe extern "C" fn(*mut c_void, *const XML_Char) -> (),
                            ),
                        );
                        XML_SetProcessingInstructionHandler(
                            parser,
                        ...
                        XML_SetCdataSectionHandler(
                            parser,
                            Some(metaStartCdataSection as unsafe extern "C" fn(*mut c_void) -> ()),
                            Some(metaEndCdataSection as unsafe extern "C" fn(*mut c_void) -> ()),
                        );
                        XML_SetCharacterDataHandler(
                            parser,
                            Some(
                        ...
                        XML_SetDoctypeDeclHandler(
                            ...
                            Some(metaEndDoctypeDecl as unsafe extern "C" fn(*mut c_void) -> ()),
                        );
                    ...
                    _ => {
                        ...
                        if requiresNotations != 0 {
                            XML_SetDoctypeDeclHandler(
                                ...
                                Some(endDoctypeDecl as unsafe extern "C" fn(*mut c_void) -> ()),
                            );
                            XML_SetNotationDeclHandler(
                                parser,
                                Some(
