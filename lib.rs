...
pub mod filemap_h {
    pub const XML_MAX_CHUNK_LEN: ::core::ffi::c_int = crate::limits_h::INT_MAX / 2i32 + 1i32;
}
...
pub mod internal_h {
    ...
    pub const EXPAT_ALLOC_TRACKER_ACTIVATION_THRESHOLD_DEFAULT: ::core::ffi::c_int = 67108864i32;
...
pub mod expat_h {
    ...
    pub const XML_TRUE: crate::expat_h::XML_Bool = 1u8;

    pub const XML_FALSE: crate::expat_h::XML_Bool = 0u8;
